...
def bayes_filter_a(
    ...
    # prediction step
    bel_x1_blank = bel_x0_color * p_xblank_given_xcolor_upaint + bel_x0_blank * p_xblank_given_xblank_upaint
    bel_x1_color = bel_x0_color * p_xcolor_given_xcolor_upaint + bel_x0_blank * p_xcolor_given_xblank_upaint
    # correction step
    bel_x1_blank = p_zcolor_given_xblank * bel_x1_blank   
    bel_x1_color = p_zcolor_given_xcolor * bel_x1_color

    # normalization
    nu = 1.0 / (bel_x1_blank + bel_x1_color)
